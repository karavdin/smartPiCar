# Inspired by 
# 1) https://github.com/tensorflow/examples/blob/master/lite/examples/object_detection/raspberry_pi/detect.py
# 2) https://github.com/raspberrypi/picamera2/blob/main/examples/tensorflow/real_time_with_labels.py
